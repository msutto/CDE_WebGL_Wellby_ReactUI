...
export var DropdownMenu = function DropdownMenu(_ref) {
    ...
    var _React$useState5 = React.useState(selectedValue),
        _React$useState6 = _slicedToArray(_React$useState5, 2),
        currentValue = _React$useState6[0],
        setCurrentValue = _React$useState6[1];

    var _React$useState7 = React.useState(selectedIndex),
    ...
    var optionIndex = -1;
    if (currentValue !== null && optionList !== null) optionIndex = optionList.findIndex(function (elem) {
        return elem === currentValue;
